...
<tr>
	...
	<td class="onesetup_column"><input style="min-width:10px; !important;width:19% !important;" type="checkbox" name="product_addon_option_onesetup[<?php echo $loop; ?>][<?php echo  $anni;?>]" <?php echo ( $option['onesetup']==1 ) ? 'checked' : '' ?> value="1" /></td>
	<td class="actions" width="1%"><button type="button" class="remove_addon_option button remove_addon_option_<?php echo $loop; ?>">x</button></td>
</tr>
<?php $anni++; ?>