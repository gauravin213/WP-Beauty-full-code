					...
					<table cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								...
								<th class="onesetup_column"><?php _e('Onesetup', 'woocommerce-product-addons'); ?></th>
								<th width="1%"></th>
							</tr>
						</thead>
						<tfoot>
							<tr>
								<td colspan="5"><button type="button" class="add_addon_option button add_addon_option_<?php echo $loop; ?>"><?php _e('New&nbsp;Option', 'woocommerce-product-addons'); ?></button></td>
							</tr>
						</tfoot>
						<tbody>
							<?php  $anni=0;
