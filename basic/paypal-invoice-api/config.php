<?php
//$sandbox = get_option('diesel_pi_sandbox');



/*$log_results = get_option('diesel_pi_log');
 ...
 */
if(get_option('diesel_pi_sandbox')=='false'){
   $sandbox = false; //TRUE;
}else{
   $sandbox = true; //TRUE; 
}
...
$rest_client_id = get_option('diesel_pi_clientid');
$rest_client_secret = get_option('diesel_pi_client_secret'); 
 ...
 */
$log_results = get_option('diesel_pi_log'); //false;
$log_path = $_SERVER['DOCUMENT_ROOT'].'/logs';
//$log_path = '/logs';
