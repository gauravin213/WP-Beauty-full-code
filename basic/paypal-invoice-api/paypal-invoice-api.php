...
function custom_add_meta_boxes_paypal_invoice(){
    ...
    //add_meta_box( 'cus_shipping_in_admin', 'Shipping methods', 'cus_shipping_in_admin', 'shop_order', 'side', 'low' );
}

/*function cus_shipping_in_admin(){
    
    
    $pp = WC()->shipping->get_shipping_methods();
    ...
    ?>
    <ul>
	<li><input type="radio" name=""><label>Method1</label></li>
    </ul>
    <?php
